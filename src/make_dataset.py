...
Sample command:
python -m src.make_dataset --dataset_config dataset_configs/squad.yaml \
    --data_dir "test_data/datasets" \
    --hf_cache_dir "cache" \
...
parser.add_argument(
    "--redo",
    action="store_true",
    help="If set, will re-run the script even if the processed dataset already exists.",
)
...
def main(args: argparse.Namespace):
    ...
    train_fpath, test_fpath = construct_processed_dataset_paths(args=args)
